...
public class CalcTest {
    ...
    @Test
    public void testGetMultiplication6() throws Exception {
        System.out.println("testGetUmn6()");
        assertEquals(4, classCalc.getMultiplication(2, 2), 0.01);
    }

    @Test
    public void testGetMultiplication7() throws Exception {
        System.out.println("testGetUmn7()");
        assertEquals(4.84, classCalc.getMultiplication(2.2, 2.2), 0.01);
    }

    @Test
    public void testGetMultiplication8() throws Exception {
    ...
    @Test
    public void testGetDivision11() throws Exception {
        System.out.println("testGetDivision11()");
        assertEquals(1, classCalc.getDivision(2, 2), 0.01);
    }

    @Test
    public void testGetDivision12() throws Exception {
        System.out.println("testGetDivision12()");
        assertEquals(1.095, classCalc.getDivision(-2.3, -2.1), 0.01);
    }

    @Test
    public void testGetDivision3() throws Exception {
        System.out.println("testGetDivision3()");
        assertEquals(1.095, classCalc.getDivision(2.3, 2.1), 0.01);
    }
